...
src/
  ...
  s13_label_bug_figure.py    Stage 13: generates Figure 2 from Stage 11's results
data/
...
figures/
  ...
  Figure_2.png                naive vs. corrected label split, generated by s13_label_bug_figure.py
```
...
python src/s13_label_bug_figure.py
```
...
All four stages are self-contained, read only from `data/` and `results/`
